...
var ICON_WHITE_B64="data:image/png;base64,";
var ICON_COLOR_B64="data:image/png;base64,";
...
function PinScreen(props){
  ...
  return ce("div",{style:{minHeight:"100vh",background:"linear-gradient(160deg,"+MD+" 0%,"+MB+" 60%,"+ML+" 100%)",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",padding:"40px 16px"}},
    ce("div",{style:{display:"flex",alignItems:"center",gap:12,marginBottom:28}},ce("img",{src:ICON_WHITE_B64,alt:"Nuve",style:{height:48,width:"auto"}}),ce("span",{style:{fontSize:36,fontWeight:800,color:"#fff",letterSpacing:"-1px"}},"nuve")),
...
function App(){
  ...
  var topBar=ce("div",{style:{background:WH,borderRadius:12,padding:"10px 14px",marginBottom:12,border:"0.5px solid #E2E2E0",display:"flex",alignItems:"center",gap:8,flexWrap:"wrap"}},
    ...
    ce("div",{style:{display:"flex",alignItems:"center",gap:7,flexShrink:0}},ce("img",{src:ICON_COLOR_B64,alt:"Nuve",style:{height:24,width:"auto"}}),ce("span",{style:{fontSize:17,fontWeight:800,color:"#111",letterSpacing:"-0.5px"}},"nuve")),
    ColorBar(),
